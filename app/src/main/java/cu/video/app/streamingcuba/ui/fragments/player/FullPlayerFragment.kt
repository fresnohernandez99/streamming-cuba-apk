...
@AndroidEntryPoint
class FullPlayerFragment : BaseFragment(), View.OnClickListener,
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFullPlayerBinding.inflate(layoutInflater, container, false)
    ...
    override fun configView(vb: ViewBinding) {
        ...
        (vb as FragmentFullPlayerBinding).apply {
